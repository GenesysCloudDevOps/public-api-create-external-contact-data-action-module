A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Create External Contact
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-create-external-contact-data-action-module.git?ref=main"
    action_name        = "Create External Contact"
